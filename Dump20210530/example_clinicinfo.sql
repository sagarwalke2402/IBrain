...
CREATE TABLE `clinicinfo` (
  ...
  `clinicname` varchar(2000) NOT NULL,
...
INSERT INTO `clinicinfo` VALUES (1,'***noitaroproc latn akkis***','***esoj nas***','***ac***'),(2,'***ntryohroproc latn atudgsfs***','***esoj nas***','***ac***');
...
-- Dump completed on 2021-05-30 13:11:21
